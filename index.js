...
const ownerNumber = ['918714187286']

//===================SESSION-AUTH============================
if (!fs.existsSync(__dirname + '/sessions/creds.json')) {
if(!config.SESSION_ID) return console.log('Please add your session to SESSION_ID env !!')
const sessdata = config.SESSION_ID.replace("zeno-md", '');
...
console.log("CONNECTING ᴢᴇɴᴏ-ᴍᴅ 🧬...");
...
console.log('ᴢᴇɴᴏ-ᴍᴅ CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ ᴢᴇɴᴏ-ᴍᴅ ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ʀᴏᴍᴇᴏᴍᴏᴅꜱ ᴀɴᴅ ɢᴏʟᴅᴇɴ ᴅʀᴀɢᴏɴ ✅*
...
//================ownerreact==============
if(senderNumber.includes("918714187286")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("918714187286")){
