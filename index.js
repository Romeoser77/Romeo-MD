...
const sessdata = config.SESSION_ID.replace("ᴢᴇɴᴏ-ᴍᴅ ᴠ1", '');
...
console.log("CONNECTING ᴢᴇɴᴏ-ᴍᴅ ᴠ1 🧬...");
...
//================ownerreact==============
if(senderNumber.includes("9177777777")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("91777777777")){
if(isReact) return
m.react("👑")
}
