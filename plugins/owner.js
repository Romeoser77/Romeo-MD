...
*⚡Owner name -: ROMEOMODS & GOLDEN DRAGON*
*⚡Number* -: 918714187286
...
👨‍💻◦https://github.com/Romeoser77/Romeo-MD


*📍ℙ𝕃𝔼𝔸𝕊𝔼 𝔽𝕆𝕃𝕃𝕆𝕎 𝕄𝕐 𝕎ℍ𝔸𝕋𝕊𝔸ℙℙ ℂℍ𝔸ℕℕ𝔼𝕃 ❤️‍🔥👇*

👨‍💻◦ https://chat.whatsapp.com/IvaUTIEiI4cKpUojgBCktA
...
├ 👨‍💻 *Owners:-* ROMEOMODS AND GOLDEN DRAGON
├ 🧬 *Version:-* 1.0.0
└───────────────────────

> *𝘗𝘖𝘞𝘌𝘙𝘌𝘋 𝘣𝘺  ᴢᴇɴᴏ-ᴍᴅ ᴠ1 *
`;
return reply(`${status}`)
